...
export default function DangerAlert({
    ...
    return (
        <>
            ...
            <div
                aria-live="assertive"
                className="z-[100001] pointer-events-none fixed inset-2 top-4 flex items-end px-4 py-6 sm:items-start sm:p-6"
            >
                <div className="flex flex-col items-center w-full space-y-4 sm:items-end">
                    ...
                    >
                        <div className="relative w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg pointer-events-auto isolate ring-1 ring-black ring-opacity-5">
                            <div
                                className="absolute top-0 bottom-0 left-0 bg-red-100 -z-10"
